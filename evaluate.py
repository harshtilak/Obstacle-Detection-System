...
for i in range(0, len(actual_depth)):
    err = abs(actual_depth[i]-stereo_depth[i])
    total_err += (err/actual_depth[i])

print("Average error rate:", (total_err/len(actual_depth))*100, "%")